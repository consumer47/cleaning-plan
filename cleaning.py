...
def interactive_input():
    ...
    names = input("Enter the names of people in the flat, separated by commas: ").split(',')
    team_size = int(input("Enter the team size: "))

    return start_date, end_date, names, team_size

def main():
    parser = argparse.ArgumentParser(description="Generate a weekly cleaning plan for shared flats.")
    ...
    parser.add_argument('--names', type=str, required=True, help='Comma-separated list of names for people in the flat.')
    parser.add_argument('--team-size', type=int, required=True, help='How many people a team consists of.')
